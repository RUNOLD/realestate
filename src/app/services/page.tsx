            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 container mx-auto space-y-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="order-2 lg:order-1">
                        ...
                        <h2 className="text-3xl font-serif font-bold text-slate-900 mb-4">Property Management</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-2">
                        ...
                        <h2 className="text-3xl font-serif font-bold text-slate-900 mb-4">Property Sourcing</h2>
                        <p className="text-slate-600 text-lg leading-relaxed mb-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="order-2 lg:order-1">
                        ...
                        <h2 className="text-3xl font-serif font-bold text-slate-900 mb-4">Building Materials Supply</h2>
                        <p className="text-slate-600 text-lg leading-relaxed mb-6">
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={idx} className="bg-white p-8 rounded-xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                                <span className="text-6xl font-bold text-slate-100 absolute -top-4 -right-4 select-none group-hover:text-accent/10 transition-colors">
                                    {item.step}
                                </span>
            ...
            <section className="py-20 bg-primary text-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link 
                            href="/contact" 
                            className="inline-flex h-12 items-center justify-center rounded-md bg-white px-8 text-sm font-medium text-primary shadow hover:bg-slate-100 transition-colors"
                        >
