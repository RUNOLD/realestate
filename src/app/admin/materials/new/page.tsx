            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Add Material</h1>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-1 bg-gray-50 border-b border-gray-100">
                        {/* Optional decorative header strip or progress indicator could go here */}
                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe the material specifications, quality, or usage..."
                                            required
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button type="button" variant="outline" className="shrink-0 h-11" disabled>
                                        Preview
                                    </Button>
                                </div>
