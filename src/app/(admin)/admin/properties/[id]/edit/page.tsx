                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Update property details and status.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input id="location" name="location" defaultValue={property.location} required className="pl-9 h-11" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="images" name="images" defaultValue={property.images && property.images.length > 0 ? property.images[0] : ""} placeholder="https://..." className="h-11 font-mono text-xs" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input id="price" name="price" type="number" defaultValue={property.price} required className="pl-8 h-11 text-lg font-semibold" />
                                        </div>
                                    </div>
