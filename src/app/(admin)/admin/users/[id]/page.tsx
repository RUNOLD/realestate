...
export default async function UserDetailPage(props: PageProps) {
    ...
    // Redirect Staff and Admins to their specific page
    ...
    return (
        <div className="space-y-8">
            ...
            {user.role === 'LANDLORD' ? (
                ...
                <div className="space-y-8">
                    {/* TOP SECTION: TWO COLUMNS (Contact & Quick Stats) */}
                    ...
                    {/* EXTENDED PROFILE DETAILS (Full Width Below) */}
                    <div className="mt-8">
                        <h2 className="text-2xl font-serif font-bold text-primary mb-6">Full Tenant Profile</h2>
