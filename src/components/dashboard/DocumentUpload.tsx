...
export function DocumentUpload({ userId }: { userId: string }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setMessage(result.error || "Error uploading");
            }
        } catch (e) {
    ...
    return (
        <div className="bg-white p-6 rounded-xl border border-gray-200">
            <h3 className="font-bold text-gray-900 mb-4">Document Hub</h3>
            ...
            <div className="space-y-4">
                ...
                {/* Drop Zone */}
                <div
                    className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${isDragging ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-gray-300'
                        }`}
                ...
                >
                    {message === 'Success' ? (
                        <div className="flex flex-col items-center text-green-600">
                            ...
                            <Button variant="link" size="sm" onClick={() => setMessage(null)} className="text-green-700">Upload Another</Button>
                        </div>
                    ) : (
                        <>
