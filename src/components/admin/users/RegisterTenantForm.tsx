...
export function RegisterTenantForm() {
    ...
    return (
        <form action={action} className="space-y-8 pb-20">
            ...
            <div className={`space-y-6 animate-in slide-in-from-right-4 duration-300 ${step === 1 ? 'block' : 'hidden'}`}>
            ...
            <div className={`space-y-6 animate-in slide-in-from-right-4 duration-300 ${step === 2 ? 'block' : 'hidden'}`}>
                <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
            ...
            <div className={`space-y-6 animate-in slide-in-from-right-4 duration-300 ${step === 3 ? 'block' : 'hidden'}`}>
                <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
            ...
            {/* STEP 4: GUARANTORS */}
            <div className={`space-y-6 animate-in slide-in-from-right-4 duration-300 ${step === 4 ? 'block' : 'hidden'}`}>
                <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
            ...
            {/* STEP 5: DECLARATION */}
            <div className={`space-y-6 animate-in slide-in-from-right-4 duration-300 ${step === 5 ? 'block' : 'hidden'}`}>
                <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
